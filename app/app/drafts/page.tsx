...
export default function DraftsPage() {
  ...
  const { messages, isLoading, deleteMessages, markAsRead, archiveMessages, refreshMessages, toggleStarMessage, restoreMessages, markAsUnread } = useMessages('drafts', draftsId);
      ...
      <div className="flex flex-1 overflow-hidden relative z-10">
        ...
        <AnimatePresence>
          {selectedEmailId && (
            ...
            >
              <MessageViewer emailId={selectedEmailId} folder="drafts" onClose={() => setSelectedEmailId(null)} />
            </motion.div>
          )}
        </AnimatePresence>
      </div>
